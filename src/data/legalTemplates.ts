...
export const LEGAL_TEMPLATES: LegalTemplate[] = [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    placeholders: [
      ...
      { key: 'REMUNERACION', label: 'Mejor remuneración mensual, normal y habitual', type: 'number' },
...
SERÁ JUSTICIA.`,
...

  {
    ...
    placeholders: [
      ...
      { key: 'REMUNERACION_REGISTRADA', label: 'Remuneración registrada', type: 'number' },
    ],
...
SERÁ JUSTICIA.`,
...

  {
    ...
    placeholders: [
      ...
      { key: 'CUOTA_PROVISORIA', label: 'Monto de cuota provisoria solicitada', type: 'number' },
...
SERÁ JUSTICIA.`,
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    placeholders: [
      ...
      { key: 'MONTO_RECLAMO', label: 'Monto total reclamado ($)', type: 'number' },
      { key: 'LETRADO', label: 'Nombre del letrado', type: 'text' },
    ],
...
SERÁ JUSTICIA.`,
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    placeholders: [
      ...
      { key: 'CANON_INICIAL', label: 'Canon locativo mensual inicial ($)', type: 'number' },
      ...
      { key: 'DEPOSITO', label: 'Depósito en garantía ($)', type: 'number' },
...
_________________________          _________________________
...

  {
    ...
    placeholders: [
      ...
      { key: 'MONTO_CAPITAL', label: 'Monto del capital del pagaré ($)', type: 'number' },
